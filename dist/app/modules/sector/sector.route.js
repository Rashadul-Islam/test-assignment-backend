...
router.post(
  ...
  (0, validateRequest_1.default)(
    sector_validation_1.SectorValidation.createSectorZodSchema
  ),
  (0, auth_1.default)(),
  sector_controller_1.SectorController.createSector
);
router.get(
  '/',
  (0, auth_1.default)(),
  sector_controller_1.SectorController.getAllSector
);
